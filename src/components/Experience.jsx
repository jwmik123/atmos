...
import { Float, useScroll, PerspectiveCamera } from "@react-three/drei";
...
export const Experience = () => {
  ...
  useFrame((_state, delta) => {
    ...
    // Make the group look at the point ahead
      ...
      <group ref={cameraGroup}>
        ...
        <group ref={airplane}>
          <Float floatIntensity={1} speed={1.5} rotationIntensity={0.5}>
            <Airplane scale={[0.005, 0.005, 0.005]} position-y={0} />
          </Float>
        </group>
      </group>
      ...
      <group position-y={-2}>
        <mesh>
          <extrudeGeometry
            args={[
              shape,
              { steps: LINE_POINTS, bevelEnabled: false, extrudePath: curve },
            ]}
          />
